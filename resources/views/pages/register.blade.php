...
@section('content')
    <div class="wrraper">
        <x-heading class="pt-4 semi-bold text-center">Create Your Account</x-heading>
        <hr class="h-px my-2" />
        <div class="p-10">
            <form class="max-w-md mx-auto">
                ...
                <div class="flex items-start mb-5">
                    <div class="flex items-center h-5">
                        <label for="terms" class="ms-2 text-sm font-medium">If you don't have an account, please
                            <a href="#" class="text-blue-600 hover:underline dark:text-blue-500 mr-10">register</a></label>
                    </div>
                </div>
                <div class="flex items-start mb-5">
                    <div class="flex items-center h-5">
                    ...
                    <label for="terms" class="ms-2 text-sm font-medium">I agree with the
                        <a href="#" class="text-blue-600 hover:underline dark:text-blue-500 mr-10">terms and
                            conditions</a></label>
                </div>
